...
Project นี้เป็นชุด Automation Test สำหรับหน้า Register ของ empeo ตาม requirement ของโจทย์
...
ด้านล่างคือ coverage หลักที่ออกแบบไว้ (แบบย่อ):
...
> รายละเอียด implementation อยู่ใน `tests/registration.spec.js`

## 2) Fixed Test Data (ตามโจทย์)
...
Repo นี้พร้อมส่งแบบ **code files/project พร้อม run instruction** ตามโจทย์แล้ว โดยมี:

- Test case design (ใน README + test IDs)
- Automation script (Playwright tests)
- Run instructions
